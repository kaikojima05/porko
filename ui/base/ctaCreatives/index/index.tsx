...
export default function CtaCreatives({ creatives }: CtaCreativesProps) {
    ...
    sortCreatives.forEach((work, index) => {
      ...
      const observer = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
          const elements = creativesRefs.current[
            index
          ]?.current?.querySelectorAll(".iframely-embed > div");
        ...
        <div className={classNames("grid grid-cols-2 gap-6 w-full", "md:flex")}>
          ...
          <div className={classNames("hidden", "md:block md:w-full md:shrink")}>
            <div className="[&>*]:mt-10 first:[&>*]:mt-0">
              ...
              >
                <p>
                  自由に綴ったエッセイ等、お仕事からは離れた自主制作コンテンツの一覧です。
                </p>
